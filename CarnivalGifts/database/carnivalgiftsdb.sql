...
--
-- Host: 127.0.0.1
-- Generation Time: May 07, 2019 at 12:08 PM
...
(5, 'ADMIN', '', '', '', '', 0, 'Admin@CarnivalGifts.com', '', 'CarnivalADMIN8899*');
...
(3, 202, 'Japan', 'Tokyo', 'Tokyo.jpg', '2200.00', 'Tokyo Drift', 'YES'),
(4, 115, 'Philippines', 'Manilla', 'Manilla.jpg', '1100.00', 'Manilla Tour', 'YES'),
...
(8, 260, 'Panama', 'Panama City', 'Panama.png', '3200.25', 'Panama Luxury Cruise', 'NO'),
(9, 205, 'Italy', 'Venice', 'Destination3.jpg', '2500.10', 'Venice Tour', 'NO'),
(10, 181, 'Italy', 'Naples', 'Destination3.jpg', '1825.50', 'Naples Tour', 'NO'),
(11, 120, 'Japan', 'Tokyo', 'Tokyo.jpg', '2020.20', 'Tokyo Drift', 'NO'),
(12, 240, 'Philippines', 'Cebu', 'Manilla.jpg', '1675.04', 'Cebu Cruise', 'NO'),
(13, 133, 'Philippines', 'Cebu', 'Manilla.jpg', '1386.00', 'Cebu Cruise', 'NO');
...
(8, 'Cebu Scuba Diving', '140.45', 'Purchase a Scuba Diving trip in Cebu for two people. Whale Sharks are often found here!', 'scuba.jpg', 'Cebu'),
(9, 'In-Room Meal', '95.50', 'Have a Three Course Meal delivered to your room', 'meal.jpg', 'ALL');
...
INSERT INTO `item_order` (`item_order_id`, `order_id`, `item_id`, `amount_Due`) VALUES
(7, 26, 9, '95.50'),
(8, 26, 3, '200.00'),
(15, 29, 1, '120.00'),
(16, 29, 3, '200.00');
...
--
ALTER TABLE `beneficiary`
  MODIFY `beneficiaryID` int(18) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `cruise`
--
ALTER TABLE `cruise`
  MODIFY `cruise_num` int(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `cruise_order`
--
ALTER TABLE `cruise_order`
  MODIFY `order_id` int(64) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `item`
  MODIFY `item_id` int(16) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `item_order`
--
ALTER TABLE `item_order`
  MODIFY `item_order_id` int(64) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
